...
cmd:option('-iter', 470000, 'the number of training iterations')
...
cmd:option('-saveiter', 100, 'training iterations to save video/weights')
...
for i=1,params.iter*params.N+5 do
...
--data = LoadSensorData("/home/jaylewis/DeepTracking/data.t7", params)

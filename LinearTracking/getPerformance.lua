...
for index = start_i,end_i do
  ...
  name = '/home/justin94lewis/Documents/DeepTracking/Linear_Tracking/weights_model0/'.. index*1000 ..".dat"
  --print(name)
...
--for index = start_i,end_i do
--  --print('Loading weights ')
--  name = '/home/justin94lewis/Documents/DeepTracking/Linear_Tracking/weights_model1/'.. index*1000 ..".dat"
--  --print(name)
--  WEIGHT=torch.load(name)
--  total_cost = 0
--  number = 100
...
--torch.save('lin_costs1.t7',COSTS)
--end

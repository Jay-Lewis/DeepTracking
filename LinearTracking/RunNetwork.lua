...
wdirectory = "/home/justin94lewis/Documents/DeepTracking/Linear_Tracking/weights_model1/"
...
function evalModel(weights,index)
	...
	torch.setdefaulttensortype('torch.FloatTensor')
	for i = 1,#input-1 do
		image.save(directory .. params.model .. '/input' .. i .. '.png',  input[i])
